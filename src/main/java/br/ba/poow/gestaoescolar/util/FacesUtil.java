...
/**
 *
 * Autor: Andre Portugal
 * Data : 01/01/2012
 * Sistema de Gestão de Notas Fiscais Eletrônicas de Serviços
 */
...
public class FacesUtil {
	...
	private static void exibirMensagem(FacesMessage.Severity severity, String mensagem) {
		FacesMessage facesMessage = new FacesMessage(severity, "Legislativo Digital informa", mensagem);
